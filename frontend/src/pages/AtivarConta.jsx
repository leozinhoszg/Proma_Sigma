...
export default function AtivarConta() {
  ...
  const getPasswordStrength = (password) => {
    ...
    if (strength <= 3) return { class: 'progress-warning', width: 66, label: 'Media', textClass: 'text-warning' };
      ...
      <div className="min-h-screen flex bg-base-100">
          ...
          <div className="relative z-10 flex flex-col justify-center items-center w-full p-12 text-white">
            <div className="max-w-md text-center">
              ...
              <p className="text-white/80 text-lg leading-relaxed drop-shadow">
                Sistema de gestao e monitoramento de contratos com fornecedores
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-base-100 border-l-4 border-primary/20">
          <div className="w-full max-w-md animate-fadeInUp text-center">
            ...
            <h2 className="text-2xl font-bold text-error mb-3">Link invalido ou expirado</h2>
      ...
      <div className="min-h-screen flex bg-base-100">
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-base-100 border-l-4 border-primary/20">
          <div className="w-full max-w-md animate-fadeInUp text-center">
            ...
            <h2 className="text-2xl font-bold text-success mb-3">Conta ativada com sucesso!</h2>
          ...
          <div className="max-w-md text-center">
            ...
            <div className="mt-12 space-y-4 text-left">
              <div className="flex items-center gap-4 p-3 rounded-lg bg-white/10 backdrop-blur-sm">
                ...
                <span className="text-sm">Use no minimo 6 caracteres</span>
              </div>
              <div className="flex items-center gap-4 p-3 rounded-lg bg-white/10 backdrop-blur-sm">
                <div className="w-10 h-10 rounded-lg bg-white/20 flex items-center justify-center shrink-0">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <span className="text-sm">Combine letras, numeros e simbolos</span>
              </div>
              <div className="flex items-center gap-4 p-3 rounded-lg bg-white/10 backdrop-blur-sm">
                <div className="w-10 h-10 rounded-lg bg-white/20 flex items-center justify-center shrink-0">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <span className="text-sm">Evite senhas obvias ou repetidas</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-base-100 border-l-4 border-primary/20">
        <div className="w-full max-w-md animate-fadeInUp">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-success/10 text-success mb-6">
            ...
            <span className="text-sm font-medium">Bem-vindo ao PROMA SIGMA!</span>
          </div>

          {/* Title */}
          <h1 className="text-3xl font-bold text-base-content mb-2">Ativar Conta</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              {senha && (
                <div className="mt-3">
                  <div className="flex items-center justify-between mb-1">
                    <span className="text-xs text-base-content/60">Forca da senha:</span>
              ...
              <p className="text-xs text-base-content/50 mt-2">Minimo de 6 caracteres</p>
            </div>
            ...
            <div>
              ...
              {confirmarSenha && senha !== confirmarSenha && (
                <p className="text-xs text-error mt-2">As senhas nao conferem</p>
              )}
              {confirmarSenha && senha === confirmarSenha && (
