    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-base-content/60">Visão geral do sistema de controle</p>
        </div>
        <button className="btn btn-primary btn-sm shadow-soft" onClick={loadDashboardData}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 stagger-animate">
        <div className="stat-card-glass error">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-base-content/60 font-medium">Medições Atrasadas</p>
              <p className="text-3xl font-bold text-error mt-1">{stats.atrasadas}</p>
            </div>
        ...
        <div className="stat-card-glass warning">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-base-content/60 font-medium">Medições Pendentes</p>
              <p className="text-3xl font-bold text-warning mt-1">{stats.pendentes}</p>
            </div>
        ...
        <div className="stat-card-glass info">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-base-content/60 font-medium">Fornecedores</p>
              <p className="text-3xl font-bold text-info mt-1">{stats.totalFornecedores}</p>
            </div>
        ...
        <div className="stat-card-glass success">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-base-content/60 font-medium">Contratos</p>
              <p className="text-3xl font-bold text-success mt-1">{stats.totalContratos}</p>
            </div>
                ...
                <tbody>
                  {atrasadas.map((m, idx) => (
                    <tr key={idx} className="hover:bg-base-200/30">
                      ...
                      <td className="text-base-content/70">{m.contratoNumero}</td>
      ...
      <div className="glass-card p-6">
        ...
        <div className="flex flex-wrap gap-3">
          <Link to="/fornecedores" className="btn btn-outline btn-sm glass-card-hover">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
            </svg>
            Gerenciar Fornecedores
          </Link>
          <Link to="/contratos" className="btn btn-outline btn-sm glass-card-hover">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
            </svg>
            Gerenciar Contratos
          </Link>
          <Link to="/relatorio" className="btn btn-outline btn-sm glass-card-hover">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
